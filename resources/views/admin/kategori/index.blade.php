...
@section('content')
    <div class="bg-white p-8 rounded-lg shadow-lg">
        ...
        @endif
        <a href="{{ route('admin.kategori.create') }}" class="bg-brand-green hover:bg-brand-green-dark hover:text-dark-green text-white font-bold py-2 px-4 rounded mb-4 inline-block">
