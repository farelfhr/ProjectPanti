...
<div class="bg-[#F1F0E9] rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105 overflow-hidden">
    <div class="p-6">
        ...
        <div class="flex gap-2">
            <button onclick="openDonationModal{{ $p->id_panti }}()" class="flex-1 bg-[#41644A] hover:bg-[#0D4715] text-[#F1F0E9] font-bold py-2 px-4 rounded-lg text-center flex items-center justify-center transition-colors duration-300">
...
{{-- Donation Modal for each panti --}}
@include('components.donation-modal', ['panti' => $p, 'modalId' => 'donationModal' . $p->id_panti])
@endforeach
